...
export const MOCK_BRIEFS: AIBrief[] = [
  {
    ...
    model_name: 'mock-v0',
    confidence: 0.88,
    did_you_know: 'Rwanda has the highest percentage of women in parliament in the world — over 61% of seats in the lower house are held by women.',
  },
  {
    id: 'brief-002',
    ...
    model_name: 'mock-v0',
    confidence: 0.82,
    did_you_know: 'Nigeria has over 500 living languages — making it one of the most linguistically diverse countries on Earth.',
  },
  {
    id: 'brief-003',
    ...
    model_name: 'mock-v0',
    confidence: 0.91,
    did_you_know: 'Rwanda banned single-use plastic bags in 2008 — one of the first countries in the world to do so — and is now considered one of the cleanest nations in Africa.',
  },
]
...
export const MOCK_ACTIONS: Record<string, ActionCard[]> = {
  KEN: [
    ...
    },
    {
      ...
      country_iso3: 'KEN',
      url: 'https://www.hotosm.org/get-involved',
      description: 'Analyse WHO and World Bank health datasets to surface gaps in Kenya\'s health infrastructure. Findings inform partner NGO strategy.',
      skills_needed: ['Data analysis', 'Python or R', 'Excel'],
      remote: true,
    ...
    },
    {
      ...
      org_name: 'Launch Africa Ventures',
      org_id: 'org-enza',
      org_verification_tier: 'A',
      country_iso3: 'KEN',
    ...
    },
    {
      id: 'a-ken-4',
      type: 'volunteer',
      title: 'Agronomy advisor — smallholder farm programme',
      org_name: 'One Acre Fund',
      org_id: 'org-oneacrefund',
      org_verification_tier: 'A',
      country_iso3: 'KEN',
      url: 'https://oneacrefund.org/careers',
      description: 'Provide remote agronomic guidance to field officers supporting 10,000+ smallholder farmers in western Kenya.',
      skills_needed: ['Agronomy', 'Crop science', 'Training & facilitation'],
      remote: true,
  ...
  NGA: [
    {
      ...
      org_name: 'Malala Fund',
      org_id: 'org-egn',
      org_verification_tier: 'A',
      country_iso3: 'NGA',
      url: 'https://malala.org/donate',
      description: 'Fund scholarships and mentorship for girls at risk of dropping out in Northern Nigeria.',
      sdg_tags: [4, 5],
      sector: 'Education',
    },
    {
      ...
      description: 'Deep-dive report on Nigeria\'s electricity access gap and the role of distributed solar.',
      sdg_tags: [7, 13],
      sector: 'Energy',
    },
    {
      id: 'a-nga-3',
      type: 'volunteer',
      title: 'Medical data coordinator — remote',
      org_name: 'Médecins Sans Frontières — Africa',
      org_id: 'org-msfafrica',
      org_verification_tier: 'A',
      country_iso3: 'NGA',
      url: 'https://www.msf.org/work-msf',
      description: 'Support MSF\'s data team with patient record coordination across northern Nigeria field missions. Medical data experience required.',
      skills_needed: ['Medical records', 'Excel / Google Sheets', 'Humanitarian context'],
      remote: true,
  ...
  ETH: [
    {
      id: 'a-eth-1',
      type: 'donate',
      title: 'Emergency food assistance — Tigray & Afar',
      org_name: 'Médecins Sans Frontières — Africa',
      org_id: 'org-msfafrica',
      org_verification_tier: 'A',
      country_iso3: 'ETH',
      url: 'https://www.msf.org/donate',
      description: '3.2M people in Ethiopia require acute food assistance. MSF operates therapeutic feeding centres in conflict-affected areas.',
      sdg_tags: [2, 3, 16],
      sector: 'Humanitarian Response',
    },
    {
      id: 'a-eth-2',
      type: 'volunteer',
      title: 'GIS mapping volunteer — displacement tracking',
      org_name: 'Humanitarian OpenStreetMap Team',
      org_id: 'org-afrimapper',
      org_verification_tier: 'B',
      country_iso3: 'ETH',
      url: 'https://www.hotosm.org/get-involved',
      description: 'Build and maintain displacement maps for Ethiopia using UNHCR and ACLED data. Output feeds into partner NGO field operations.',
      skills_needed: ['GIS / QGIS', 'Geospatial data', 'Python (optional)'],
      remote: true,
  ...
  RWA: [
    {
      id: 'a-rwa-1',
      type: 'invest',
      title: 'Digital economy early-stage fund — Rwanda',
      org_name: 'AfriLabs',
      org_id: 'org-gsbi',
      org_verification_tier: 'B',
      country_iso3: 'RWA',
      url: 'https://afrilabs.com',
      description: 'Rwanda\'s ICT sector contributes 8.1% to GDP. GSBI connects global investors to vetted Kigali-based startups.',
      sdg_tags: [8, 9, 17],
    ...
    },
    {
      id: 'a-rwa-2',
      type: 'volunteer',
      title: 'Product mentor — Kigali tech startup cohort',
      org_name: 'Ashoka Africa',
      org_id: 'org-ashoka',
      org_verification_tier: 'A',
      country_iso3: 'RWA',
      url: 'https://www.ashoka.org/get-involved',
      description: 'Mentor early-stage founders in Kigali on product strategy, user research, and growth. Monthly 1:1s + group sessions.',
      skills_needed: ['Product management', 'Startup mentoring', 'User research'],
      remote: true,
      duration: 'Ongoing, ~3 hrs/month',
      sdg_tags: [8, 9],
      sector: 'Digital Economy',
    },
  ],
  ZAF: [
    {
      id: 'a-zaf-1',
      type: 'volunteer',
      title: 'Solar energy trainer — community programme',
      org_name: 'Solar Sister',
      org_id: 'org-solarsister',
      org_verification_tier: 'A',
      country_iso3: 'ZAF',
      url: 'https://solarsister.org/get-involved',
      description: 'Develop training curriculum for Solar Sister\'s women-led clean energy distribution network in rural South Africa.',
      skills_needed: ['Curriculum design', 'Clean energy basics', 'Community training'],
      remote: false,
    ...
    },
    {
      id: 'a-zaf-2',
      type: 'donate',
      title: 'Cash transfers to extreme-poverty households',
      org_name: 'GiveDirectly',
      org_id: 'org-givedirectly',
      org_verification_tier: 'A',
      country_iso3: 'ZAF',
      url: 'https://www.givedirectly.org/donate/',
      description: '100% of your donation goes directly to low-income households. GiveDirectly is the most evidence-backed cash transfer programme globally.',
      sdg_tags: [1, 10],
  ...
  TZA: [
    {
      id: 'a-tza-1',
      type: 'volunteer',
      title: 'Health systems researcher — remote',
      org_name: 'Amref Health Africa',
      org_id: 'org-amref',
      org_verification_tier: 'A',
      country_iso3: 'TZA',
      url: 'https://amref.org',
...
export const MOCK_ORGS: Organization[] = [
  ...
  { id: 'org-enza', name: 'Launch Africa Ventures', website: 'https://launchafrica.vc', mission: 'Seed-stage venture capital investing in climate-smart agri-tech and fintech across East Africa.', countries: ['KEN','TZA','RWA','UGA'], sectors: ['Agri-tech','Fintech','Climate Tech'], sdg_tags: [1,2,8,13], verification_tier: 'A', last_reviewed_at: '2026-03-01', action_types: ['invest'] },
  ...
  { id: 'org-egn', name: 'Malala Fund', website: 'https://malala.org', mission: 'Keeping girls in secondary school across Northern Nigeria through scholarships and mentorship.', countries: ['NGA'], sectors: ['Education','Gender Equality'], sdg_tags: [4,5], verification_tier: 'A', last_reviewed_at: '2026-01-20', action_types: ['donate'] },
