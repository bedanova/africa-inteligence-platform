...
const MOCK_ORGS: Organization[] = [
  ...
  { id: 'org-afrimapper', name: 'Humanitarian OpenStreetMap Team', website: 'https://www.hotosm.org', mission: 'Open geospatial data for development — mapping health, water and food security across East Africa.', countries: ['KEN','ETH','TZA'], sectors: ['Health','WASH','Food Security'], sdg_tags: [2,3,6], verification_tier: 'B', last_reviewed_at: '2026-01-15', action_types: ['volunteer','learn'] },
  { id: 'org-enza', name: 'Launch Africa Ventures', website: 'https://launchafrica.vc', mission: 'Seed-stage venture capital investing in climate-smart agri-tech and fintech across East Africa.', countries: ['KEN','TZA','RWA'], sectors: ['Agri-tech','Fintech'], sdg_tags: [1,2,13], verification_tier: 'A', last_reviewed_at: '2026-03-01', action_types: ['invest'] },
  { id: 'org-egn', name: 'Malala Fund', website: 'https://malala.org', mission: 'Keeping girls in secondary school across Northern Nigeria through scholarships and community engagement.', countries: ['NGA'], sectors: ['Education'], sdg_tags: [4,5], verification_tier: 'A', last_reviewed_at: '2026-01-20', action_types: ['donate'] },
  { id: 'org-epra', name: 'IEA Africa', website: 'https://www.iea.org/regions/africa', mission: 'Independent research and advocacy on energy access, transition and policy across Sub-Saharan Africa.', countries: ['NGA','GHA','ZAF','SEN','ETH'], sectors: ['Energy Access','Renewable Energy'], sdg_tags: [7,13], verification_tier: 'B', last_reviewed_at: '2025-12-10', action_types: ['learn','donate'] },
