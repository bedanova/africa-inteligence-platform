...
const ACTIONS = [
  // WaterAid
  { id: 'act-wateraid-1', type: 'donate', title: 'Fund safe water access in rural Kenya', description: "WaterAid's Kenya programme reaches underserved communities in arid Turkana and Marsabit counties. Each £30 provides clean water for one person for life.", org_name: 'WaterAid Africa', org_id: 'org-wateraid', org_verification_tier: 'A', country_iso3: 'KEN', url: 'https://www.wateraid.org/uk/donate', sector: 'WASH', sdg_tags: [6, 3] },
  { id: 'act-wateraid-2', type: 'donate', title: 'Emergency WASH response — Mozambique floods', description: 'Cholera prevention and clean water delivery following seasonal flooding in low-lying provinces.', org_name: 'WaterAid Africa', org_id: 'org-wateraid', org_verification_tier: 'A', country_iso3: 'MOZ', url: 'https://www.wateraid.org/uk/donate', sector: 'WASH', sdg_tags: [6, 3] },
  { id: 'act-wateraid-3', type: 'volunteer', title: 'Remote WASH data analyst (3-month)', description: "Support WaterAid's data team with analysis of water point functionality surveys across East Africa. Flexible remote hours.", org_name: 'WaterAid Africa', org_id: 'org-wateraid', org_verification_tier: 'A', country_iso3: 'KEN', url: 'https://www.wateraid.org/uk/get-involved', remote: true, duration: '3 months, ~5 hrs/week', skills_needed: ['Data analysis', 'Excel', 'GIS basics'], sector: 'WASH', sdg_tags: [6, 17] },
  // Amref
  { id: 'act-amref-1', type: 'donate', title: 'Train community health workers in Ethiopia', description: "Amref's health extension worker programme has trained 38,000+ community health workers. Donate to expand to Afar and Somali regions.", org_name: 'Amref Health Africa', org_id: 'org-amref', org_verification_tier: 'A', country_iso3: 'ETH', url: 'https://amref.org/donate', sector: 'Health', sdg_tags: [3] },
  { id: 'act-amref-2', type: 'volunteer', title: 'Medical professional — remote consultation programme', description: 'Virtual specialist consultations supporting district hospitals in Tanzania and Uganda. Minimum 2 sessions/month.', org_name: 'Amref Health Africa', org_id: 'org-amref', org_verification_tier: 'A', country_iso3: 'TZA', url: 'https://amref.org/careers', remote: true, duration: '6 months, ~4 hrs/month', skills_needed: ['Medical degree', 'Clinical experience', 'Telemedicine'], sector: 'Health', sdg_tags: [3, 17] },
  // Launch Africa Ventures
  { id: 'act-enza-1', type: 'invest', title: 'Agri-fintech seed fund — East Africa 2026', description: "Launch Africa's portfolio focuses on climate-smart agriculture and financial inclusion for smallholders in Kenya, Tanzania and Rwanda.", org_name: 'Launch Africa Ventures', org_id: 'org-enza', org_verification_tier: 'A', country_iso3: 'KEN', url: 'https://launchafrica.vc', sector: 'Agri-tech', sdg_tags: [1, 2, 8, 13] },
  // Solar Sister
  { id: 'act-solarsister-1', type: 'donate', title: 'Equip a Solar Sister entrepreneur in Nigeria', description: 'Each $200 donation helps a woman entrepreneur access clean energy products, training, and a business-in-a-bag starter kit.', org_name: 'Solar Sister', org_id: 'org-solarsister', org_verification_tier: 'A', country_iso3: 'NGA', url: 'https://solarsister.org/get-involved', sector: 'Renewable Energy', sdg_tags: [5, 7, 13] },
  { id: 'act-solarsister-2', type: 'invest', title: 'Impact investment — off-grid solar distribution', description: "Blended-finance opportunities in Solar Sister's last-mile distribution network across East Africa. Returns linked to climate impact metrics.", org_name: 'Solar Sister', org_id: 'org-solarsister', org_verification_tier: 'A', country_iso3: 'TZA', url: 'https://solarsister.org/invest', sector: 'Renewable Energy', sdg_tags: [5, 7, 13] },
  // Malala Fund
  { id: 'act-egn-1', type: 'donate', title: "Sponsor a girl's secondary education in Kano State", description: "£180/year covers school fees, books and mentoring for one girl in Northern Nigeria. 94% of sponsored girls complete secondary school.", org_name: 'Malala Fund', org_id: 'org-egn', org_verification_tier: 'A', country_iso3: 'NGA', url: 'https://malala.org/donate', sector: 'Education', sdg_tags: [4, 5] },
  // GiveDirectly
  { id: 'act-givedirectly-1', type: 'donate', title: 'Direct cash transfer to families in extreme poverty — Kenya', description: 'GiveDirectly sends cash directly to verified ultra-poor households. 89% of funds reach recipients. No restrictions on use.', org_name: 'GiveDirectly', org_id: 'org-givedirectly', org_verification_tier: 'A', country_iso3: 'KEN', url: 'https://www.givedirectly.org/give-now', sector: 'Poverty Alleviation', sdg_tags: [1, 10] },
  { id: 'act-givedirectly-2', type: 'donate', title: 'Emergency cash relief — Ethiopia drought response', description: 'Rapid unconditional cash transfers to households affected by the Horn of Africa drought. Disbursed within 48 hours of verification.', org_name: 'GiveDirectly', org_id: 'org-givedirectly', org_verification_tier: 'A', country_iso3: 'ETH', url: 'https://www.givedirectly.org/give-now', sector: 'Poverty Alleviation', sdg_tags: [1, 2] },
  // One Acre Fund
  { id: 'act-oaf-1', type: 'donate', title: 'Support smallholder farmers in Rwanda', description: 'One Acre Fund provides seeds, fertiliser on credit, and training. Average farmer sees a 50% increase in income. Donate to expand coverage.', org_name: 'One Acre Fund', org_id: 'org-oneacrefund', org_verification_tier: 'A', country_iso3: 'RWA', url: 'https://oneacrefund.org/donate', sector: 'Agriculture', sdg_tags: [1, 2, 13] },
  { id: 'act-oaf-2', type: 'volunteer', title: 'Field operations manager — East Africa', description: '12-month placement managing field teams in Kenya or Tanzania. Background in agriculture, logistics or operations required.', org_name: 'One Acre Fund', org_id: 'org-oneacrefund', org_verification_tier: 'A', country_iso3: 'KEN', url: 'https://oneacrefund.org/careers', remote: false, duration: '12 months, full-time on-site', skills_needed: ['Agriculture', 'Logistics', 'Team management'], sector: 'Agriculture', sdg_tags: [1, 2] },
  // Practical Action
  { id: 'act-pa-1', type: 'donate', title: 'Solar irrigation for smallholders in Zambia', description: 'Fund solar water pumps for farmers in Southern Province — reducing dependence on rain-fed agriculture and extending the growing season.', org_name: 'Practical Action', org_id: 'org-practicalaction', org_verification_tier: 'A', country_iso3: 'ZMB', url: 'https://practicalaction.org/donate', sector: 'Renewable Energy', sdg_tags: [7, 2, 13] },
  { id: 'act-pa-2', type: 'learn', title: 'Free online course: Climate-resilient agriculture in Africa', description: "Practical Action's open learning series on sustainable farming, water harvesting, and post-harvest loss reduction. 6 hours total.", org_name: 'Practical Action', org_id: 'org-practicalaction', org_verification_tier: 'A', country_iso3: null, url: 'https://practicalaction.org/learning', sector: 'Agriculture', sdg_tags: [2, 13] },
  // MSF
  { id: 'act-msf-1', type: 'donate', title: 'Emergency medical response — DR Congo', description: "MSF teams provide trauma surgery and cholera treatment in conflict-affected areas of eastern DRC. No strings attached — funding goes where it's most needed.", org_name: 'Médecins Sans Frontières — Africa', org_id: 'org-msfafrica', org_verification_tier: 'A', country_iso3: 'COD', url: 'https://www.msf.org/donate', sector: 'Humanitarian Response', sdg_tags: [3, 16] },
  { id: 'act-msf-2', type: 'volunteer', title: 'Medical/logistical field positions — Africa placements', description: 'MSF recruits doctors, nurses, logisticians and finance staff for 6–12 month field missions across sub-Saharan Africa.', org_name: 'Médecins Sans Frontières — Africa', org_id: 'org-msfafrica', org_verification_tier: 'A', country_iso3: 'ETH', url: 'https://www.msf.org/work-msf', remote: false, duration: '6–12 months, full-time on-site', skills_needed: ['Medical/nursing degree', 'Logistics', 'Humanitarian experience'], sector: 'Humanitarian Response', sdg_tags: [3, 16] },
  // AfriLabs
  { id: 'act-gsbi-1', type: 'invest', title: 'Impact-first startup portfolio — West Africa', description: 'AfriLabs curates a co-investment vehicle for screened African startups across fintech, agri-tech and health-tech in Ghana, Nigeria and Senegal.', org_name: 'AfriLabs', org_id: 'org-gsbi', org_verification_tier: 'B', country_iso3: 'GHA', url: 'https://afrilabs.com', sector: 'Digital Economy', sdg_tags: [8, 9, 17] },
  { id: 'act-gsbi-2', type: 'learn', title: 'Africa Startup Ecosystem Report 2026', description: 'Free annual report on funding trends, sector growth, and emerging opportunities across African startup ecosystems. PDF + webinar.', org_name: 'AfriLabs', org_id: 'org-gsbi', org_verification_tier: 'B', country_iso3: null, url: 'https://afrilabs.com', sector: 'Digital Economy', sdg_tags: [8, 9] },
  // Humanitarian OpenStreetMap Team
  { id: 'act-afrimapper-1', type: 'volunteer', title: 'OpenStreetMap contributor — infrastructure mapping', description: 'Help map roads, health facilities and water points in unmapped areas of sub-Saharan Africa. Remote, flexible. Training provided.', org_name: 'Humanitarian OpenStreetMap Team', org_id: 'org-afrimapper', org_verification_tier: 'B', country_iso3: null, url: 'https://www.hotosm.org/get-involved', remote: true, duration: 'Ongoing, ~2 hrs/week', skills_needed: ['Basic computer skills', 'Attention to detail'], sector: 'Open Data', sdg_tags: [9, 11, 17] },
  // Ashoka
  { id: 'act-ashoka-1', type: 'learn', title: 'Social entrepreneur case studies — African innovators', description: "Free access to Ashoka's library of 200+ African social entrepreneur profiles, with impact metrics and replication guides.", org_name: 'Ashoka Africa', org_id: 'org-ashoka', org_verification_tier: 'A', country_iso3: null, url: 'https://www.ashoka.org/en/our-network', sector: 'Social Enterprise', sdg_tags: [4, 8, 10] },
]
